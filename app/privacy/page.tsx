function Page() {
  return (
    <section className="min-h-screen bg-[#130F40]">
      <div className="mx-auto flex max-w-7xl flex-col items-center px-5 py-8 sm:px-6 lg:px-8">
        <div className="prose prose-blue mx-auto flex w-full max-w-3xl flex-col text-left prose-headings:text-white">
          <div className="mx-auto w-full text-white">
            <h1>Re-Me Privacy Policy</h1>

            <p>
              At Re-Me, accessible from re-me.onrender.com, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by Re-Me and how we use it.
            </p>
            ...
            <p>
              Re-Me follows a standard procedure of using log files. These files
            ...
            <p>
              Like any other website, Re-Me uses &apos;cookies&apos;. These
            ...
            <p>
              Re-Me does not knowingly collect any Personal Identifiable
            ...
            <p>
              Although most changes are likely to be minor, Re-Me may change its
              Privacy Policy from time to time, and in Re-Me’s sole discretion.
              Re-Me encourages visitors to frequently check this page for any
            ...
            <h2>Contact Us</h2>
            <p>
              If you have any questions or comments, we may be reached at{" "}
              <a href="mailto:re.mereminder@gmail.com">
                re.mereminder@gmail.com
              </a>
              .
            </p>
          </div>
